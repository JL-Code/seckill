...
namespace SecKill.Migrations
{
    ...
    [Migration("20190223105821_Order_Add_UserId")]
    partial class Order_Add_UserId
    {
            ...
            modelBuilder.Entity("SecKill.Domain.AggregatesModel.SeckillGoods", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SeckillGoodsId = new Guid("01d9c264-6542-4c09-bd14-4021bfa58be0"),
                            EndDate = new DateTime(2019, 2, 23, 19, 58, 20, 839, DateTimeKind.Local).AddTicks(6575),
                            GoodsId = new Guid("b266ade2-ff83-44d3-aa60-128ab17dbf43"),
                            GoodsName = "华为（HUAWEI） mate20pro手机 馥蕾红 8G+256G 全网通（UD屏内指纹版）",
                            PictureUrl = "https://res.vmallres.com/pimages//product/6901443281213/800_800_1546486249080mp.png",
                            Quantity = 10,
                            SeckillPrice = 9.9000000000000004,
                            StartDate = new DateTime(2019, 2, 23, 18, 58, 20, 840, DateTimeKind.Local).AddTicks(9749)
                        });
                });
            ...
            modelBuilder.Entity("SecKill.Domain.AggregatesModel.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("104258e1-0936-46e8-bde0-cea2d0f49062"),
                            Address = "长江国际",
                            Password = "1",
                            UserName = "jiangy"
                        });
