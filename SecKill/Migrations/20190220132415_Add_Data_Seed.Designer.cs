...
namespace SecKill.Migrations
{
    ...
    [Migration("20190220132415_Add_Data_Seed")]
            ...
            modelBuilder.Entity("SecKill.Domain.AggregatesModel.SeckillGoods", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SeckillGoodsId = new Guid("aef28bc9-a728-40ca-ad0b-138f4dcee772"),
                            EndDate = new DateTime(2019, 2, 20, 22, 24, 15, 510, DateTimeKind.Local).AddTicks(2665),
                            GoodsId = new Guid("b266ade2-ff83-44d3-aa60-128ab17dbf43"),
                            GoodsName = "",
                            Img = "https://res.vmallres.com/pimages//product/6901443281213/800_800_1546486249080mp.png",
                            Quantity = 10,
                            SeckillPrice = 9.9000000000000004,
                            StartDate = new DateTime(2019, 2, 20, 21, 24, 15, 511, DateTimeKind.Local).AddTicks(5926)
                        });
                });
            ...
            modelBuilder.Entity("SecKill.Domain.AggregatesModel.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("3ad6ac2c-3baf-4bc1-ab4d-c96ae87c4928"),
                            Address = "长江国际",
                            Password = "1",
                            UserName = "jiangy"
                        });
